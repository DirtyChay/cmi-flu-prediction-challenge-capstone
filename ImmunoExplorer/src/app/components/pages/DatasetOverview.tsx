    ...
    <div style={{ padding: '28px 28px', fontFamily: 'Inter, sans-serif' }}>
      <div style={{ marginBottom: 24 }}>
        ...
        <p style={{ color: '#64748B', fontSize: 13, marginTop: 6, marginBottom: 0 }}>
          CMI Flu Prediction Challenge — multi-cohort influenza immunogenicity dataset
        </p>
      </div>
      ...
      <div style={{ marginBottom: 24 }}>
        <ChartCard title="Participants per Study Cohort" subtitle="Representative cohorts from 51 investigations" minHeight={220}>
