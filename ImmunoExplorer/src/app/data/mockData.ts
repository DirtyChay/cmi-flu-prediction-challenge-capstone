...
export const COHORTS = ['2019 UGA', '2020 UGA', 'SDY269', 'Legacy SDY'] as const;
export const VACCINE_ARMS = ['HD Fluzone', 'SD Fluzone', 'LAIV', 'TIV'] as const;
export const RACES = ['White', 'Black or African American', 'Asian', 'Multiracial', 'Other/Unknown'] as const;
...
COHORTS.forEach((cohort, ci) => {
  for (let i = 0; i < cohortSizes[ci]; i++) {
    ...
    const race =
      rv < 0.53 ? 'White'
      : rv < 0.68 ? 'Black or African American'
      : rv < 0.80 ? 'Asian'
      : rv < 0.88 ? 'Multiracial'
      : 'Other/Unknown';
...
const rise28: Record<string, Record<string, number>> = {
  'HD Fluzone': { H1N1: 2.9, H3N2: 2.6, 'B/Victoria': 2.4, 'B/Yamagata': 2.2 },
  'SD Fluzone': { H1N1: 2.2, H3N2: 2.0, 'B/Victoria': 1.8, 'B/Yamagata': 1.6 },
  'LAIV':       { H1N1: 1.8, H3N2: 1.6, 'B/Victoria': 1.4, 'B/Yamagata': 1.3 },
  'TIV':        { H1N1: 1.5, H3N2: 1.4, 'B/Victoria': 1.2, 'B/Yamagata': 1.1 },
};
...
export const TASKS = [
  ...
  { id: '4.4',  label: 'Geo Mean D28 (3 strains)',     strain: 'H1N1',       day: 28  },
  { id: '4.5',  label: 'Geo Mean D28 (all strains)',   strain: 'H1N1',       day: 28  },
  { id: '4.6',  label: '% Variants HAI≥40 D28',       strain: 'H1N1',       day: 28  },
  { id: '4.7',  label: 'H1N1 D365 Titer',             strain: 'H1N1',       day: 365 },
  { id: '4.8',  label: 'H3N2 D365 Titer',             strain: 'H3N2',       day: 365 },
  { id: '4.9',  label: 'B/Vic D365 Titer',            strain: 'B/Victoria', day: 365 },
  { id: '4.10', label: 'Geo Mean D365 (3 strains)',    strain: 'H1N1',       day: 365 },
];
